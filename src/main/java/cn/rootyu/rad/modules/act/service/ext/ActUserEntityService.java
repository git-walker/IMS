 ...
 */
package cn.rootyu.rad.modules.act.service.ext;

import cn.rootyu.rad.common.utils.SpringContextHolder;
import cn.rootyu.rad.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new cn.rootyu.rad.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new cn.rootyu.rad.modules.sys.entity.User(null, userId)))){

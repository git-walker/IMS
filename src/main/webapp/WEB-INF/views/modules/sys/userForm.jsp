	...
	<div class="widget-main" > 
		<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/doSave" method="post" class="form-horizontal">
			<div class="form-group">			
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="name">姓名:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">				
						<form:input path="name" htmlEscape="false" maxlength="50" class="form-control width-100" placeholder="请输入姓名" />
					</div>
				</div>			
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="loginName">登录名:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">				
			...
			<div class="form-group">
				...
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="no">工号:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">				
						<form:input path="no" htmlEscape="false" maxlength="50" class="form-control width-100" placeholder="请输入工号" />
					</div>
				</div>
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="loginFlag">允许登录:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">
						<label>
							<input id="loginFlag" name="loginFlag" ${user.loginFlag=='1'?'checked':''} class="ace ace-switch ace-switch-4 btn-flat" type="checkbox" />
							<span class="lbl"></span>
						</label>
			...
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="office.name">部门:</label>
				<div class="col-xs-12 col-sm-5">
			...
			<div class="form-group">
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="phone">办公电话:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">
						<form:input path="phone" htmlEscape="false" maxlength="50" class="form-control width-100" placeholder="请输入办公电话"/> 
					</div>
				</div>
				<label class="control-label col-xs-12 col-sm-1 no-padding" for="mobile">手机:</label>
				<div class="col-xs-12 col-sm-5">
					<div class="clearfix">

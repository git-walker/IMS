...
<div class="widget-body" id="officeDivId">
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/doSave" method="post" class="form-horizontal">
		<div class="form-group">			
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="name">机构名称:</label>
			<div class="col-xs-12 col-sm-5">
				<div class="clearfix">				
					<form:input path="name" htmlEscape="false" maxlength="50" class="form-control width-100" placeholder="请输入机构名称" />
				</div>
			</div>			
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="code">机构编码:</label>
			<div class="col-xs-12 col-sm-5">
				<div class="clearfix">				
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="parent.name">上级机构:</label>
			<div class="col-xs-12 col-sm-5">
			...
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="area.name">归属区域:</label>
			<div class="col-xs-12 col-sm-5">
				<div class="clearfix check-out input-group">
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="type">机构类型:</label>
			<div class="col-xs-12 col-sm-5">
			<c:choose>
			...
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="grade">机构级别:</label>
			<div class="col-xs-12 col-sm-5">
		...
		<div class="form-group">
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="useable">是否可用:</label>
			<div class="col-xs-12 col-sm-5">
				<form:select  path="useable" class="chosen-select form-control width-100" data-placeholder="点击选择...">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false" />
				</form:select>
			</div>
			<label class="control-label col-xs-12 col-sm-1 no-padding" for="company.id">所属公司:</label>
			<div class="col-xs-12 col-sm-5">
